(function ($) {
  $.fn.mtree = function (options) {
    ...
    node.each(function (index, val) {
      ...
      $(this).children(":first-child").append("<label class='cursor'><label/>");
      $(this).addClass(
        "mtree-node mtree-" + (settings.collapsed ? "closed" : "open")
      );
      $(this)
        .children("ul")
        .addClass(
          "mtree-level-" + ($(this).parentsUntil(this, "ul").length + 1)
        );
    }); 
    ...
    node.children(":first-child").on("click.mtree", function (e) {
      ...
      if (
        (settings.close_same_level || $(".csl").hasClass("active")) &&
        !isOpen
      ) {
        ...
        if ($.Velocity) {
          ...
          close_items
            .delay(100)
            .stop()
            .slideToggle(settings.duration, function () {
              setNodeClass($(this).parent(), true);
            });
        }
      }
      ...
      if (!isOpen && $.Velocity && settings.listAnim)
      ...
      if ($.Velocity) {
        ...
        el.stop().slideToggle(settings.duration);
      }
