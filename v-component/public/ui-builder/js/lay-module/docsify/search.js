    ...
    var loop = function (i) {
      ...
      if (postTitle) {
        keywords.forEach(function (keyword) {
          ...
          var regEx = new RegExp(ignoreDiacriticalMarks(keyword).replace(/[|\\{}()[\]^$+*?.]/g, "\\$&"), "gi");
          var indexTitle = -1;
          var indexContent = -1;
          handlePostTitle = postTitle ? ignoreDiacriticalMarks(postTitle) : postTitle;
          handlePostContent = postContent ? ignoreDiacriticalMarks(postContent) : postContent;
